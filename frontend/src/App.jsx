...
function App() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-100 text-slate-700 font-bold">
        Cargando sistema...
      </div>
    );
  }
    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10">
        ...
        <Routes>
          ...
          <Route path="/personas/:id" element={<ProtectedRoute permissions={["planes.personas.ver", "planes.personas.ver_propio"]}> <EditarPersona soloLectura /> </ProtectedRoute>} />
