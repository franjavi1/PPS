...
function TablaPrincipal({
    ...
    propiedadesFiltro = [], // Campos por los que se puede buscar internamente
    columnaOrdenInicial = '',
    direccionOrdenInicial = 'asc',
    accionesPorFila, // Función que renderiza el menú de acciones para cada fila (opcional)
    propiedadKey = 'id'
}) {
    ...
    // FILTRADO Y ORDENAMIENTO DINIÁMICO
