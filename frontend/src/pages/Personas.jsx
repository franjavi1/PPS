...
import { Pencil, PlusCircle, RefreshCcw, Search, Trash2, User, Eye } from "lucide-react";
...
export default function Personas() {
  ...
  async function eliminarPersona(id) {
    ...
    try {
      ...
      setError(err.message || "No se pudo eliminar the persona");
    }
  }
                    ...
                    <tr key={p.id} className="border-b border-slate-200 hover:bg-slate-50">
                      ...
                      <td className="px-5 py-5 text-center">
                        <div className="flex justify-center gap-3">
                          <button onClick={() => navigate(`/personas/${p.id}`)} className="text-blue-600 hover:text-blue-800 font-semibold flex items-center gap-1"><Eye size={16} /> Ver</button>
