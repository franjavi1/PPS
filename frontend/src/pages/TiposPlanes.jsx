...
function TiposPlanes() {
  ...
  function editarTipo(tipo) {
    ...
    setEditandoId(tipo.id_tipo_planes);
  }
  ...
  async function eliminarTipo(id) {
    const confirmar = confirm("Seguro que queres eliminar este tipo de plan?");
        ...
        <section className="bg-white rounded-2xl shadow-md border border-slate-200 p-8">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-slate-500 mt-1">
                Administra las opciones que aparecen al crear un plan.
              </p>
            </div>
          </div>
          ...
          >
            <input
              ...
              placeholder="Ej: Formacion Inicial"
              className="flex-1 h-12 px-4 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
            />
            ...
            {editandoId && (
              <button
                ...
                className="h-12 px-5 border border-slate-300 rounded-lg text-slate-700 font-bold hover:bg-slate-100 flex items-center justify-center gap-2 cursor-pointer"
              >
                <X size={19} />
                Cancelar
              </button>
            ...
            <button
              type="submit"
              className="h-12 px-6 bg-red-700 text-white rounded-lg font-bold hover:bg-red-800 flex items-center justify-center gap-2 cursor-pointer"
            >
            ...
            <table className="w-full text-left">
              <thead className="bg-slate-50 border-b border-slate-200">
                <tr>
                  ...
                  <th className="px-6 py-4 text-right text-slate-700">
                    Acciones
                  </th>
                </tr>
              </thead>
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className="flex justify-end gap-4">
                          ...
                          <button
                            type="button"
                            onClick={() => eliminarTipo(tipo.id_tipo_planes)}
