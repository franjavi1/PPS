...
@requires_permission("planes.tipos_autoridad.ver")
...
@requires_permission("planes.tipos_autoridad.crear")
...
@requires_permission("planes.tipos_autoridad.editar")
...
@requires_permission("planes.tipos_autoridad.eliminar")
