...
@requires_permission("planes.asignaturas.ver")
def get_asignaturas():
...
@requires_permission("planes.asignaturas.crear")
...
@requires_permission("planes.asignaturas.editar")
...
@requires_permission("planes.asignaturas.eliminar")
