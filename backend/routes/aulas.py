...
@requires_permission("micro1.aulas.ver")
def get_aulas():
    aulas = obtener_todos()
...
@requires_permission("micro1.aulas.crear")
def crear_aula():
...
@requires_permission("micro1.aulas.editar")
def editar_aula(id):
    aula = obtener_por_id(id)
...
@requires_permission("micro1.aulas.eliminar")
